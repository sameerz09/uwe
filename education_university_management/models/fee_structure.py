...
class FeeStructure(models.Model):
    ...
    def _compute_total(self):
        ...
        self.amount_total = sum(
            line.due_amount for line in self.structure_line_ids)
    ...
    def _onchange_structure_line_ids(self):
        ...
        #     line.due_amount = line.fee_type_id.lst_price
        # for line in self.structure_line_ids:
        #     if line.first_scholarship_id:
        #         line.due_amount = line.fee_amount * (line.first_scholarship_id.percentage / 100)
        #     if line.second_scholarship_id:
        #         line.due_amount = line.fee_amount * (line.second_scholarship_id.percentage / 100)