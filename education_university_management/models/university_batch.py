...
class UniversityBatch(models.Model):
    ...
    timetable_id = fields.Many2one('university.timetable', string="Timetable", required=False)
    email_sender_id = fields.Many2one('ir.mail_server', string="Email Sender", required=False)
